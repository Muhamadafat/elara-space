...
if (!$publisherId) {
    redirect(SITE_URL . '/admin/publishers/index.php', 'Invalid publisher ID', 'error');
}

// Get publisher data
$publisher = $db->fetchOne("SELECT * FROM publishers WHERE id = ?", [$publisherId]);

if (!$publisher) {
    redirect(SITE_URL . '/admin/publishers/index.php', 'Publisher not found', 'error');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($formData['name'])) {
        ...
        $query = "UPDATE publishers SET
                  ...
                  address = ?, website = ?, partnership_status = ?, commission_rate = ?
                  WHERE id = ?";
        ...
        if ($db->execute($query, $params)) {
            logActivity($currentUser['id'], 'edit_publisher', 'publishers', 'Updated publisher: ' . $formData['name']);
            redirect(SITE_URL . '/admin/publishers/index.php', 'Publisher berhasil diupdate!', 'success');
        } else {
            $error = 'Gagal mengupdate publisher. Silakan coba lagi.';
        }
    }
}

$pageTitle = 'Edit Publisher - ' . SITE_NAME;
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h2 fw-bold mb-1">Edit Publisher</h1>
                    ...
                    <form method="POST">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i>Update Publisher
                            </button>
                        </div>
                    </form>
                </div>
