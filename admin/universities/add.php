...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($formData['code'])) {
        ...
        $checkCode = $db->fetchOne("SELECT id FROM universities WHERE code = ?", [$formData['code']]);
        if ($checkCode) {
            $error = 'Kode university sudah digunakan';
        } else {
            $query = "INSERT INTO universities (code, name, address, phone, email)
                      VALUES (?, ?, ?, ?, ?)";
            ...
            if ($db->execute($query, $params)) {
                logActivity($currentUser['id'], 'add_university', 'universities', 'Added university: ' . $formData['name']);
                redirect(SITE_URL . '/admin/universities/index.php', 'University berhasil ditambahkan!', 'success');
            } else {
                $error = 'Gagal menambahkan university. Silakan coba lagi.';
            }
        }
    }
}

$pageTitle = 'Add University - ' . SITE_NAME;
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h2 fw-bold mb-1">Tambah University Baru</h1>
                    ...
                    <form method="POST">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Contoh: UGM, UI, ITB, UNPAD, UNDIP</small>
                                </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i>Simpan University
                            </button>
                        </div>
                    </form>
                </div>
